                    ...
                    <body>
                        ...
                        <p>
                            ...
                            <table>
                                ...
                                <tr><th>Brand</th><td>{{vehicleInfo.Make}}</td></tr>
                                <tr><th>Model</th><td>{{vehicleInfo.Model}}</td></tr>
                            </table>
                        </p>

                        <p>
                            <strong>Conditions during the violation:</strong>
                            <table>
                        ...
                        <p>
                            ...
                            <table>
                                <tr><th>Maximum speed violation</th><td>{{speedingViolation.ViolationInKmh}} km/h</td></tr>
                        ...
                        <p><strong>Sanction handling:</strong></p>

                        <p>
                            If the amount of the fine is to be determined by the prosecutor, you will receive a notice
                            to appear in court shortly.
                        </p>

                        <p>
                            Otherwise, you must pay the sanctioned fine <strong>within 8 weeks</strong> after the date of this
                            email. If you fail to pay within 8 weeks, you will receive a first reminder email and <strong>the
                            fine will be increased to 1.5x the original fine amount</strong>. If you fail to pay within 8 weeks
                            after the first reminder, you will receive a second and last reminder email and <strong>the fine
                            will be increased to 3x the original fine amount</strong>. If you fail to pay within 8 weeks
